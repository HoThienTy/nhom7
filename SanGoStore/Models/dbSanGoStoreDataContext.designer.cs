...
namespace SanGoStore.Models
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="SanGoStore")]
	public partial class dbSanGoStoreDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteSanPham(SanPham instance);
		...
		public dbSanGoStoreDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["SanGoStoreConnectionString"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public dbSanGoStoreDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public dbSanGoStoreDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public dbSanGoStoreDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public dbSanGoStoreDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnMaLoaiChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="MaSP", Storage="_MaSP", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int MaSP
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="TenSP", Storage="_TenSP", DbType="NVarChar(100) NOT NULL", CanBeNull=false)]
		public string TenSP
		{
			get
			{
